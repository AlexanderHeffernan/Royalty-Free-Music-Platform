        ...
        <div class="col2">
            <div class="part">
                ...
                <div id="audio-player-container">
                    ...
                    <button class="nextButton" id="skip-icon" onclick="next()"><img src="resources/bootstrap_icons/skip-end-fill_white.svg" style="width:1.5625rem;height:1.5625rem"></img></button>
